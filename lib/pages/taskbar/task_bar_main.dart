...
class _TaskBarState extends State<TaskBar> {
  ...
  double taskW(BuildContext context) => MediaQuery.of(context).size.width * 0.35;
  double taskW2(BuildContext context) => MediaQuery.of(context).size.width * 1;
  double taskH(BuildContext context) => MediaQuery.of(context).size.height * 0.08;
  double taskH2(BuildContext context) => MediaQuery.of(context).devicePixelRatio * 20;
  ...
  void _showCustomMenu() {
    ...
    showMenu(
        ...
        context: context,
        items: <PopupMenuEntry<int>>[PlusMinusEntry(taskH(context), taskW(context), colorC)],
